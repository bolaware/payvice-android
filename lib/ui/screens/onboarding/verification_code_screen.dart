...
class VerificationCodeScreen extends StatefulWidget {
  ...
  VerificationCodeScreen({@required this.argument});
            ...
            body: OnboardingContainer(
              child: Column(
                children: [
                  ...
                  Text("Verify Phone number", style: Theme.of(context).textTheme.headline2,),
...
class VerificationCodeArgument {
  String otpPrefix;
  final String mobileNumber;

  VerificationCodeArgument(
